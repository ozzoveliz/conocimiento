...
add_filter( 'plugin_action_links_' . plugin_basename(Echo_Multiple_Knowledge_Bases::$plugin_file), 'emkb_add_plugin_action_links' , 10, 2 );
 ...
 * @return array
 */
function emkb_add_plugin_row_meta($links, $file) {
	if ( $file != 'echo-multiple-knowledge-bases/echo-multiple-knowledge-bases.php' ) {
		return $links;
	}
...
add_filter( 'plugin_row_meta', 'emkb_add_plugin_row_meta', 10, 2 );
