 ...
 */
	...
	$style_array = apply_filters('eventon_inline_styles_array', array(
		...
		array(
			...
			'css'=>'color:#$', 'var'=>'evcal__fc6',	'default'=>$preset_data['evo_color_1']
		),array(
			'item'=>'#evcal_list .eventon_list_event .evcal_desc em a',
			'css'=>'color:#$', 'var'=>'evcal__fc7',	'default'=>$preset_data['evo_color_1']
		),
		...
		array(
			...
			'css'=>'color:#$', 'var'=>'evcal__fc2',	'default'=>$preset_data['evo_color_1']
		),array(
			'item'=>'.evcal_evdata_row .evcal_evdata_cell h2, .evcal_evdata_row .evcal_evdata_cell h3, .evorow .evo_clik_row h3, 
			.evcal_evdata_row .evcal_evdata_cell h3 a',
			'css'=>'color:#$', 'var'=>'evcal__fc4',	'default'=>$preset_data['evo_color_1']
		),array(
		...
		array(
			...
			'css'=>'color:#$', 'var'=>'evcal_header1_fc',	'default'=>$preset_data['evo_color_1']
		),
		array(
		...
		,array(
			...
			'multicss'=>array(
				...
				array('css'=>'background-color:#$', 'var'=>'evcal__jm002',	'default'=>$preset_data['evo_color_1'])
			)			
		),array(
...
.ajde_evcal_calendar .calendar_header .evcal_arrows.evcal_btn_prev:hover:before,
	...
	.evo_footer_nav .evcal_arrows.evcal_btn_next:hover:before',
		...
		// postponed
		array(
			'item'=>'.eventon_events_list .eventon_list_event .evcal_desc span.evo_above_title span.postponed, .evo_pop_body .evcal_desc span.evo_above_title span.postponed',
			'multicss'=>array(
		...
		// moved online
		array(
			'item'=>'.eventon_events_list .eventon_list_event .evcal_desc span.evo_above_title span.movedonline, .evo_pop_body .evcal_desc span.evo_above_title span.movedonline',
			'multicss'=>array(
		...
		// rescheduled
		array(
			'item'=>'.eventon_events_list .eventon_list_event .evcal_desc span.evo_above_title span.rescheduled, .evo_pop_body .evcal_desc span.evo_above_title span.rescheduled',
			'multicss'=>array(
		...
		array(
			...
			'css'=>'background-color:#$!important', 'var'=>'evcal__cancel_event_4x','default'=>'464646',
		),array(
		...
		// single events
			array(
				...
				'multicss'=>array(
					array('css'=>'color:#$', 'var'=>'evose_1','default'=>$preset_data['evo_color_2'])
				)						
			),array(
		...
		// timezone
			array(
				'item'=>'.eventon_list_event .evcal_desc em.evo_mytime.tzo_trig i
				',
				'css'=>'color:#$', 'var'=>'evo_tzoa','default'=>'2eb4dc'
			),
			array(
				'item'=>'.eventon_list_event .evcal_desc em.evo_mytime,
		...
		// repeat header
			array(
				...
				'multicss'=>array(
					...
					array('css'=>'color:#$', 'var'=>'evo_rep_1c','default'=> $evo_color_1)
				)				
			),
			...
			array(
				...
				'css'=>'color:#$', 'var'=>'evo_rep_2c','default'=>$evo_color_2
			),
			array(
	...
	// STYLES
	echo (!empty($opt['evo_ftimgheight']))? ".evcal_evdata_img{height:". esc_attr( $opt['evo_ftimgheight'] ) ."px}":null ;
		
		if(!empty($opt['evcal__fc6'])){
			echo "#evcal_widget .eventon_events_list .eventon_list_event .evcal_desc .evcal_desc_info em{
				color:#". esc_attr( $opt['evcal__fc6'] )."
			}";
		}
		
		// featured event styles
		if(!empty($opt['evo_fte_override']) && $opt['evo_fte_override']=='yes'){
			echo "#evcal_list .eventon_list_event .evcal_list_a.featured_event{border-left-color:#". esc_attr( eventon_styles('ca594a','evcal__ftec', $opt) )."!important;}";
		}
