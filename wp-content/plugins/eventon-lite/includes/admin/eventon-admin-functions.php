...
// check if repeat post data are good to go
	function eventon_is_good_repeat_data(){
		...
		return ( isset($postdata['evcal_rep_freq'])
			&& isset($postdata['evcal_repeat']) 
			&& $postdata['evcal_repeat']=='yes')? 	true: false;
	}
...
// get converted unix time for saving event date time using $_POST u2.2.12
