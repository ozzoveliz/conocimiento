	...
	<div id="eventon-fields-bulk" class="inline-edit-col">
		<fieldset class="inline-edit-col-left">
			<div id="eventon-fields" class="inline-edit-col evo_bedit_fields">
				<p class='evo_subheader'><?php esc_html_e('Event Data','eventon');?></p>
			<?php
				$fields = apply_filters('evo_quick_edit_event_add_fields',array(
					...
					/*
					'_evo_tz'=> array(
						'L'=>__('Event Time Zone','eventon'),
						'O'=> $help->get_timezone_array( ),
					),
					*/			
				));
				...
				foreach($fields as $field=>$val){					
					?>
					<label class='inline-edit-<?php echo esc_attr( $field );?>'>
						<span class='title'><?php echo esc_attr( $val['L'] );?></span>
						<select name='<?php echo $field;?>'>
							<option value='-'><?php esc_html_e('— No Change —','eventon');?></option>
						<?php 
						 	$O = isset($val['O']) ? array_map('esc_html', $val['O'] ) : array( __('Yes','eventon'), __('No','eventon'));
		...
		<fieldset class="inline-edit-col-right" >
			<div id="eventon-fields" class="inline-edit-col evo_bedit_fields">
				<p class='evo_subheader'><?php esc_html_e('Location Data','eventon');?></p>
				<?php
					...
					<label class='inline-edit-<?php echo esc_attr( $field );?>'>
						...
						<select name='<?php echo $field;?>'>
							<option value='-'><?php esc_html_e('— No Change —','eventon');?></option>
						<?php 
						 	$O = isset($val['O']) ? esc_attr( $val['O'] ) : array( __('Yes','eventon'), __('No','eventon'));
				...
				?>
				<p class='evo_subheader'><?php esc_html_e('Organizer Data','eventon');?></p>
