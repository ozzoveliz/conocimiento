...
class EventON {
	...
	// defines
		...
		public $lang = 'L1';
		public $assets_path, $cal, $calendar, $evo_generator, $frontend,$mdt,$temp,$shortcodes,$ajax,$rest,$cron,$elements,$shortcode_gen,$lightbox,$gen_int,$evosv,$webhooks, $helper, $evo_admin, $taxonomies;
	...
	// template locator function to use for addons
		function template_locator($file, $default_locations, $append='', $args=''){
			...
			$paths = apply_filters('evo_file_template_paths', array(
				1=> get_template_directory() .'/'.$this->template_url. $append, // TEMPLATEPATH/eventon/--append--
				2=>$childThemePath.'/',
