...
$tag_style1 = EPKB_Utilities::get_inline_style( '', $kb_config );

$tag_style2 = EPKB_Utilities::get_inline_style( '', $kb_config );

$taxonomy_name = EPKB_KB_Handler::get_tag_taxonomy_name( $kb_config['id'] );
$tags_list = get_the_term_list( $article->ID, $taxonomy_name, '<ul class="eckb-tag-list"><li ' . $tag_style2 . '>', '</li><li '.$tag_style2.'>', '</li></ul>' );
