...
class EPKB_Modular_Main_Page extends EPKB_Layout {
	...
	private static function get_inline_styles( $kb_config ) {
		...
		if ( $kb_config['ml_categories_articles_sidebar_toggle'] == 'on' ) {
			...
			// Headings  -----------------------------------------/
			if ( in_array( $kb_config['kb_main_page_layout'], $legacy_layouts ) ) {
				if ( ! empty( $kb_config[$head_typography_setting_name]['font-size'] ) || ! empty( $kb_config[$head_typography_setting_name]['font-weight'] ) || ! empty( $kb_config['general_typography']['font-family'] ) ) {
					...
					if ( ! empty( $kb_config['general_typography']['font-family'] ) ) {
						$output .= 'font-family: ' . $kb_config['general_typography']['font-family'] . ' !important;';
					}
					$output .= '}';
				}
			}
			...
			// Articles  -----------------------------------------/
			if ( in_array( $kb_config['kb_main_page_layout'], $legacy_layouts ) ) {
				if ( ! empty( $kb_config[$article_typography_setting_name]['font-size'] ) || ! empty( $kb_config[$article_typography_setting_name]['font-weight'] ) || ! empty( $kb_config['general_typography']['font-family'] ) ) {
