...
class EPKB_ML_Articles_List {
	...
	public static function get_inline_styles( $kb_config ) {
		...
		if ( in_array( $kb_config['kb_main_page_layout'], $legacy_layouts ) ) {
				$output .= '
				#epkb-ml__module-articles-list .epkb-ml-article-section__head {' . EPKB_Utilities::get_font_css( $kb_config, 'general_typography', 'font-family' ) . '}';
		}
		$output .= '
		...
		// Articles  -----------------------------------------/
		if ( in_array( $kb_config['kb_main_page_layout'], $legacy_layouts ) ) {
				$output .= '#epkb-ml__module-articles-list .epkb-article-inner {' . EPKB_Utilities::get_font_css( $kb_config, 'general_typography', 'font-family' ) . '}';
		}
		$output .= '
