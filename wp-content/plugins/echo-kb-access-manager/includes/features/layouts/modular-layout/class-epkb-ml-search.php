...
/**
 *  Outputs the Search module for Modular Layout.
 *
...
class EPKB_ML_Search {
	...
	public function display_classic_layout() {  ?>
		...
		<!-- Classic Layout -->
		<div id="epkb-ml-search-classic-layout" class="epkb-ml-search-classic-layout--design-1">    <?php
			$this->display_search_title();  ?>
			<form id="epkb-ml-search-form">
	 ...
	 */
	public function display_modern_layout() {   ?>

		<!-- Classic Layout -->
		<div id="epkb-ml-search-modern-layout" class="epkb-ml-search-modern-layout--design-1">    <?php
			$this->display_search_title();  ?>
