...
class EPKB_Add_Ons_Features {
	...
	private static function features_list() {
		...
		$features['2024.01.01'] = array(
			...
			'title'             => __( 'FAQs and Presets', 'echo-knowledge-base'),
		...
		$features['2023.10.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'Popular Articles Feature', 'echo-knowledge-base'),
		...
		$features['2023.07.15'] = array(
			'plugin'            => __( 'Widgets', 'echo-knowledge-base'),
			'title'             => __( 'Popular Articles Widget/Shortcode', 'echo-knowledge-base'),
		...
		$features['2023.03.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'AI Assisted Writing', 'echo-knowledge-base'),
		...
		$features['2023.02.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'Draft Categories', 'echo-knowledge-base'),
		...
		$features['2022.10.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'Improve CSS loading speed', 'echo-knowledge-base'),
			'description'       => '
		...
		$features['2022.08.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'Basic Settings UI', 'echo-knowledge-base'),
		...
		$features['2022.06.01'] = array(
			...
			'title'             => __( 'Help dialog Plugin', 'echo-knowledge-base'),
		...
		$features['2022.05.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'New Backend Mode for the Editor', 'echo-knowledge-base'),
			...
			'learn_more_url'    => 'https://www.echoknowledgebase.com/documentation/kb-visual-editor/',
			'plugin-type'       => 'core',
			'type'              => 'new-feature'
		);
		...
		$features['2022.04.01'] = array(
			'plugin'            => __( 'KB Core', 'echo-knowledge-base'),
			'title'             => __( 'New Navigation Sidebar for Articles', 'echo-knowledge-base'),
	...
	private static function new_feature( $date, $args = array () ) {
		...
		switch ( $args['plugin-type']) {
			case 'add-on':
				$pluginType = '<div class="epkb-fnf__meta__addon">' . esc_html__( 'Add-on', 'echo-knowledge-base') . '</div>';
				break;
			case 'core':
				$pluginType = '<div class="epkb-fnf__meta__core">' . esc_html__( 'Core', 'echo-knowledge-base') . '</div>';
				break;
			case 'plugin':
				$pluginType = '<div class="epkb-fnf__meta__addon">' . esc_html__( 'Plugin', 'echo-knowledge-base') . '</div>';
				break;
		  case 'elementor':
			  $pluginType = '<div class="epkb-fnf__meta__addon">' . esc_html__( 'Elementor', 'echo-knowledge-base') . '</div>';
			  break;
		}
		...
		switch ( $args['type']) {
			case 'new-addon':
				$type = '<span class="epkb-fnf__header__new-add-on"> <i class="epkbfa epkbfa-plug" aria-hidden="true"></i> ' . esc_html__( 'New Add-on', 'echo-knowledge-base') . '</span>';
				break;
			case 'new-feature':
				$type = '<span class="epkb-fnf__header__new-feature">' . esc_html( $monthName ) . '</span>';
				break;
			case 'new-plugin':
				$type = '<span class="epkb-fnf__header__new-add-on"> <i class="epkbfa epkbfa-plug " aria-hidden="true"></i>' . esc_html__( 'New Plugin', 'echo-knowledge-base') . '</span>';
				break;
		  case 'widget':
			  $type = '<span class="epkb-fnf__header__widget"> <i class="epkbfa epkbfa-puzzle-piece " aria-hidden="true"></i>' . esc_html__( 'Widget', 'echo-knowledge-base') . '</span>';
			  break;
		}		?>
