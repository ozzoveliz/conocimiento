...
class EPKB_KB_Config_Category {
	...
	public function __construct() {
		...
		add_action( "{$taxonomy}_add_form_fields", array( $this, 'display_category_notices' ), 98 );  // AMGR
	...
	/** AMGR ONLY **/
	function display_category_notices() {
		$this->category_icon_message( 'epkb-icons-are-enabled','You will not see this new category until KB Manager or admin will grant access to this category for your group.', 'https://www.echoknowledgebase.com/documentation/kb-editor-workflow/', 'Learn More');
	}
