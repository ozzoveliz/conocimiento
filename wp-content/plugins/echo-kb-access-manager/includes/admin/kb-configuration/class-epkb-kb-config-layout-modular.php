	...
	public static function get_fields_specification() {
        ...
        $config_specification = array(
	        ...
	        'ml_articles_list_column_1'                             => array(
		        'label'   => esc_html__( 'Articles List 1', 'echo-knowledge-base' ),
	        ...
	        'ml_articles_list_column_2'                             => array(
		        'label'   => esc_html__( 'Articles List 2', 'echo-knowledge-base' ),
	        ...
	        'ml_articles_list_column_3'                             => array(
		        'label'   => esc_html__( 'Articles List 3', 'echo-knowledge-base' ),
	        ...
	        'ml_articles_list_popular_articles_msg'                 => array(
		        'label'       => esc_html__( 'Popular Articles Text', 'echo-knowledge-base' ),
	        ...
	        'ml_articles_list_newest_articles_msg'                  => array(
		        'label'       => esc_html__( 'Newest Articles Text', 'echo-knowledge-base' ),
	        ...
	        'ml_articles_list_recent_articles_msg'                  => array(
		        'label'       => esc_html__( 'Recently Updated Articles Text', 'echo-knowledge-base' ),
	        ...
	        'ml_categories_articles_show_more_text'                 => array(
		        'label'       => esc_html__( 'Show more', 'echo-knowledge-base' ),
		        'name'        => 'ml_categories_articles_show_more_text',
		        'max'         => '150',
		        'min'         => '1',
		        'type'        => EPKB_Input_Filter::TEXT,
		        'default'     => esc_html__( 'Show more', 'echo-knowledge-base' )
	        ),
