	...
	public static function get_fields_specification( $kb_id ) {
		...
		$config_specification = array(
			...
			'article-left-sidebar-background-color-v2' => array(
				'label'       => esc_html__( 'Background Color', 'echo-knowledge-base' ),
			...
			'article-meta-color' => array(
				'label'       => esc_html__( 'Meta Color', 'echo-knowledge-base' ),
			...
			'article-right-sidebar-background-color-v2' => array(
				'label'       => is_rtl() ? esc_html__( 'Left Sidebar Background', 'echo-knowledge-base' ) : esc_html__( 'Right Sidebar Background', 'echo-knowledge-base' ),
			...
			'sidebar_section_border_radius' => array(
				'label'       => esc_html__( 'Radius', 'echo-knowledge-base' ),
			...
			'sidebar_article_list_spacing' => array(		// TODO REMOVE
				'label'       => esc_html__( 'Between', 'echo-knowledge-base' ),
			...
			'sidebar_article_font_color' => array(
				'label'       => esc_html__( 'Sidebar Article Title Color', 'echo-knowledge-base' ),
			...
			'sidebar_article_icon_color' => array(
				'label'       => esc_html__( 'Icon Color', 'echo-knowledge-base' ),
			...
			'sidebar_article_active_font_color' => array(
				'label'       => esc_html__( 'Active Article Color', 'echo-knowledge-base' ),
			...
			'sidebar_section_head_font_color' => array(
				'label'       => esc_html__( 'Category Text', 'echo-knowledge-base' ),
			...
			'sidebar_section_head_background_color' => array(
				'label'       => esc_html__( 'Category Text Background', 'echo-knowledge-base' ),
			...
			'sidebar_section_divider_color' => array(
				'label'       => esc_html__( 'Color', 'echo-knowledge-base' ),
			...
			'sidebar_section_category_font_color' => array(
				'label'       => esc_html__( 'Subcategory Text', 'echo-knowledge-base' ),
			...
			'sidebar_category_empty_msg' => array(
				'label'       => esc_html__( 'Empty Category Notice', 'echo-knowledge-base' ),
			...
			'category_box_container_background_color' => array(
				'label'       => esc_html__( 'Container Background Color', 'echo-knowledge-base' ),
			...
			'article_content_toolbar_button_background'     => array(
				'label'       => esc_html__( 'Button Background Color', 'echo-knowledge-base' ),
				'name'        => 'article_content_toolbar_button_background',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
				'default'     => '#ffffff'
			),
			'article_content_toolbar_button_background_hover' => array(
				'label'       => esc_html__( 'Button Background Hover Color', 'echo-knowledge-base' ),
			...
			'article_content_toolbar_icon_hover_color'      => array(
				'label'       => esc_html__( 'Icon Hover Color', 'echo-knowledge-base' ),
				'name'        => 'article_content_toolbar_icon_hover_color',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
				'default'     => '#000000'
			),
			'article_content_toolbar_border_color'          => array(
				'label'       => esc_html__( 'Border Color', 'echo-knowledge-base' ),
			...
			'article_content_toolbar_text_color'            => array(
				'label'       => esc_html__( 'Text Color', 'echo-knowledge-base' ),
				'name'        => 'article_content_toolbar_text_color',
				'type'        => EPKB_Input_Filter::COLOR_HEX,
				'default'     => '#000000'
			),
			'article_content_toolbar_text_hover_color'      => array(
				'label'       => esc_html__( 'Text Hover Color', 'echo-knowledge-base' ),
			...
			'prev_next_navigation_hover_text_color' => array(
				'label'       => esc_html__( 'Hover: Text Color', 'echo-knowledge-base' ),
			...
			'prev_next_navigation_hover_bg_color' => array(
				'label'       => esc_html__( 'Hover: Background Color', 'echo-knowledge-base' ),
			...
			'faq_empty_msg' => array(
				'label'       => esc_html__( 'Empty FAQs Notice', 'echo-knowledge-base' ),
				'name'        => 'faq_empty_msg',
				'max'         => '150',
				'mandatory'   => false,
				'type'        => EPKB_Input_Filter::TEXT,
	...
	public static function shared_configuration() {
		...
		$shared_specification = array(
			...
			'section_head_alignment' => array(
				'label'       => esc_html__( 'Text Alignment', 'echo-knowledge-base' ),
			...
			'article_font_color' => array(
				'label'       => esc_html__( 'Article Title Color', 'echo-knowledge-base' ),
			...
			'article_icon_color' => array(
				'label'       => esc_html__( 'Article Icon Color', 'echo-knowledge-base' ),
			...
			'section_head_font_color' => array(
				'label'       => esc_html__( 'Category Name Color', 'echo-knowledge-base' ),
			...
			'section_head_description_font_color' => array(
				'label'       => esc_html__( 'Category Description Color', 'echo-knowledge-base' ),
			...
			'section_divider_color' => array(
				'label'       => esc_html__( 'Divider Color', 'echo-knowledge-base' ),
