...
class EPKB_KB_Config_Specs {
	...
	public static function get_fields_specification( $kb_id ) {
		...
		$config_specification = array(
			...
			'article-structure-version' => array(	// TODO remove after upgrades
			...
			'article_toc_position' => array(    // TODO REMOVE
			...
			'article_toc_position_from_top' => array(   // TODO REMOVE
			...
			/******************************************************************************
			 *
			 *  FAQ Module / Shortcode - TODO expose to UI and shortcode?
			 *
			 ******************************************************************************/
			...
			'faq_border_style' => array(
				...
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
					'sharp'      => __( 'Sharp', 'echo-knowledge-base' ),
					'rounded'    => __( 'Rounded', 'echo-knowledge-base' ),
					//'thick'      => __( 'Thick', 'echo-knowledge-base' )
				),
				'default'     => 'rounded'
			),
			'faq_border_mode' => array(
				'label'       => __( 'Border Mode', 'echo-knowledge-base' ),
				'name'        => 'faq_border_mode',
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
					'none'          => __( 'None', 'echo-knowledge-base' ),
					'all_around'    => __( 'All Around', 'echo-knowledge-base' ),
					'separator'     => __( 'Separator', 'echo-knowledge-base' )
				),
				'default'     => 'all_around'
			),
			'faq_compact_mode' => array(
				'label'       => __( 'Compact Mode', 'echo-knowledge-base' ),
				'name'        => 'faq_compact_mode',
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
					'compact_small'            => __( 'Small', 'echo-knowledge-base' ),
					'compact_medium'           => __( 'Medium', 'echo-knowledge-base' ),
				),
				'default'     => 'compact_medium'
			),
			'faq_open_mode' => array(
				'label'       => __( 'Open Mode', 'echo-knowledge-base' ),
				'name'        => 'faq_open_mode',
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
					'accordion_mode'   => __( 'Accordion - Collapsed Articles', 'echo-knowledge-base' ),
					'toggle_mode'      => __( 'Toggle - Show one Article at a time', 'echo-knowledge-base' ),
					'show_all_mode'    => __( 'Show All - Show all Articles', 'echo-knowledge-base' ),
				),
				'default'     => 'accordion_mode'
			),
			'faq_question_space_between' => array(
				'label'       => __( 'Space Between Questions', 'echo-knowledge-base' ),
				'name'        => 'faq_question_space_between',
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
					'space_none'     => __( 'None', 'echo-knowledge-base' ),
					'space_small'    => __( 'Small', 'echo-knowledge-base' ),
					'space_medium'   => __( 'Medium', 'echo-knowledge-base' ),
				),
			...
			'faq_icon_type' => array(
				'label'       => __( 'Icon to Expand/Collapse FAQs', 'echo-knowledge-base' ),
				'name'        => 'faq_icon_type',
				'type'        => EPKB_Input_Filter::SELECTION,
				'options'     => array(
					...
					'icon_arrow_caret'                          => _x( 'Arrow Caret', 'icon type', 'echo-knowledge-base' ),
					'icon_arrow_angle'                          => _x( 'Arrow Angle', 'icon type', 'echo-knowledge-base' ),
				),
				'default'     => 'icon_plus'
			),
			...
			'faq_empty_msg' => array(
				'label'       => __( 'Empty FAQs Notice', 'echo-knowledge-base' ),
				'name'        => 'faq_empty_msg',
				'max'         => '150',
				'mandatory' => false,
				'type'        => EPKB_Input_Filter::TEXT,
				'default'     => __( 'FAQs coming soon', 'echo-knowledge-base' )
			),
	...
	public static function shared_configuration() {
		...
		$shared_specification = array(
			...
			'width' => array(       // used also by Advanced Search box width
			...
			'article_search_toggle' => array(       // turn search on or off (non-modular/modular/ASEA)
			...
			'article_search_layout' => array(       // deprecated: used for non-modular search box (modular has ml_article_search_layout )
				...
				'options'     => array(
					...
					'epkb-search-form-2' => __( 'Search button is below', 'echo-knowledge-base' ),
					'epkb-search-form-3' => __( 'No search button', 'echo-knowledge-base' ),
					'epkb-search-form-0' => __( 'No search box', 'echo-knowledge-base' )        // TODO REMOVE
				),
				'default'     => 'epkb-search-form-1'
			),
			...
			'section_divider_color' => array(
				'label'       => __( 'Divider Color', 'echo-knowledge-base' ),
