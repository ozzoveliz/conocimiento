	...
	private static function upgrade_to_v11_40_0( &$kb_config ) 	{
		...
		if ( ( $kb_config['kb_main_page_layout'] == EPKB_Layout::GRID_LAYOUT || $kb_config['kb_main_page_layout'] == EPKB_Layout::SIDEBAR_LAYOUT ) &&
			...
			if ( $elay_config_valid && $kb_config['kb_main_page_layout'] == EPKB_Layout::GRID_LAYOUT ) {
				$kb_config['section_head_category_icon_color'] = $elay_config['grid_section_head_icon_color'];
				$kb_config['section_category_font_color'] = $elay_config['grid_section_body_text_color'];
				$kb_config['section_border_radius'] = $elay_config['grid_section_border_radius'];
				$kb_config['section_border_width'] = $elay_config['grid_section_border_width'];
				$kb_config['section_border_color'] = $elay_config['grid_section_border_color'];
				$kb_config['section_body_background_color'] = $elay_config['grid_section_body_background_color'];
				$kb_config['section_head_background_color'] = $elay_config['grid_section_head_background_color'];
				$kb_config['section_divider_color'] = $elay_config['grid_section_divider_color'];
				$kb_config['section_head_font_color'] = $elay_config['grid_section_head_font_color'];
