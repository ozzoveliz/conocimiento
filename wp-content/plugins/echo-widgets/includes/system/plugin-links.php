 ...
 */
function widg_add_plugin_action_links ( $links ) {
	$my_links = array(
...
add_filter( 'plugin_action_links_' . plugin_basename(Echo_Widgets::$plugin_file), 'widg_add_plugin_action_links' , 10, 2 );
 ...
 * @return array
 */
function widg_add_plugin_row_meta($links, $file) {
	if ( $file != 'echo-widgets/echo-widgets.php' ) {
		return $links;
	}
...
add_filter( 'plugin_row_meta', 'widg_add_plugin_row_meta', 10, 2 );
