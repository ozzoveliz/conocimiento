...
class WIDG_KB_Config_Controller {
	...
	public function __construct() {
		...
		add_filter( WIDG_KB_Core::WIDG_ALL_WIZARDS_GET_CURRENT_CONFIG, array( $this, 'get_current_config' ), 10, 2 );
		add_filter( WIDG_KB_Core::WIDG_KB_CONFIG_SAVE_INPUT_V3, array( $this, 'save_new_kb_config_changes' ), 10, 4 );
	}
