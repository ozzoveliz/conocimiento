 ...
 */
class WIDG_Popular_Articles_Widget extends WP_Widget {

	public function __construct() {
		parent::__construct( 'widg_popular_articles', 'Echo KB - ' . __( 'Popular Articles', 'echo-widgets' ),
			array(
				'description' => __( 'Displays a list of the most popular articles.', 'echo-widgets' )
			)
		);
	}
	...
	public function form( $instance ) {
		...
		$defaults = array(
			'title'              => __( 'Popular Articles', 'echo-widgets' ),
