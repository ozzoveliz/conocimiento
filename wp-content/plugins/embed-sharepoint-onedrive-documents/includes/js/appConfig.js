...
$(document).on('click', `#mo_sps_fetch_client_secret_auto`, function(){
    mo_sps_show_test_connection('auto');
});
...
function mo_sps_show_test_connection(type) {
    ...
    var testWindow = window.open(appConfig.test_url + "&type=" + type, "TEST Connection", "scrollbars=1 width=800, height=650 popup=yes");
