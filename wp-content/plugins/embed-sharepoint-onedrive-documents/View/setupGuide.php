        ...
        <div class="mo-epbr-setup-tab-content-tile">
            <div class="mo-epbr-setup-tab-content-tile-content mo-epbr-guide-text">
              ...
              <ol>
                ...
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/auto_connection_step1.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                <li>You will be prompted with Azure AD Login Page. Log in using your <b>Azure AD/SharePoint credentials</b>.</li>
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/auto_connection_step2.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                <li>Select <b>Consent on behalf of your organization</b> option and click on <b>Accept</b> button.</li>
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/auto_connection_step3.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                <li>If you are successfully connected, you can see similar window as shown in the below image</li>
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/plugin_test_connection.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                </ul>
              </ol>
              ...
              <ul class="mo-epbr-guide-ul">
                ...
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/doc_preview_step.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
              </ul>
              ...
              <ul class="mo-epbr-guide-ul">
                ...
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/18_step.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                <li>Copy and paste this shortcode into pages or posts</li>
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/19_step.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                <li>You can embed documents to your pages and posts using Gutenberg Block</li>
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/gutenberg.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
                <li>Click On publish and view post to get all documents on your page/post.</li>
                <div style="margin-bottom:20px;"></div>
                <img width="95%" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/short.png');?>" loading="lazy" class="mo-epbr-guide-image" alt="Azure AD user sync with WordPress - Admin consent">
