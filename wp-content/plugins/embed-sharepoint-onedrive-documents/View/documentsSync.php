...
class documentsSync {
	...
	public function mo_sps_display__tab_details() {
        ...
        $selected_folder_path = wpWrapper::mo_sps_get_option(pluginConstants::SPS_SEL_FOLDER_PATH);
        $selected_folder_path = isset($selected_folder_path) && $selected_folder_path ? $selected_folder_path : '';
        ...
        $document_sync_metdata = [
            ...
            'folder_icon_url' => esc_url(MO_SPS_PLUGIN_URL . '/images/folder.svg'),
            ...
            'loader_gif' => esc_url(MO_SPS_PLUGIN_URL . '/images/loader.gif'),
            'load_icon' => esc_url(MO_SPS_PLUGIN_URL . '/images/Chasing_arrows.gif'),
            'file_icon' => esc_url(MO_SPS_PLUGIN_URL . '/images/file.png'),
            'worddoc_icon' => esc_url(MO_SPS_PLUGIN_URL . '/images/msword_file.png'),
            'exceldoc_icon' => esc_url(MO_SPS_PLUGIN_URL . '/images/msexcel_file.png'),
            'pdfdoc_icon' => esc_url(MO_SPS_PLUGIN_URL . '/images/pdf_file.png'),
            'emptyFolderDrop_icon' => esc_url(MO_SPS_PLUGIN_URL . '/images/empty_folder_drop.svg'),
            'download' => esc_url(MO_SPS_PLUGIN_URL . '/images/download.svg'),
            'redirect' => esc_url(MO_SPS_PLUGIN_URL . '/images/redirect.svg'),
            'error'=> esc_url(MO_SPS_PLUGIN_URL . '/images/error.svg'),
        ];

?>
        <div class="mo-ms-tab-content" style="width:70%;">
    ...
    <?php
        $this->mo_sps_display_generate_shortcode();
    }
    ...
    ?>
        <div id="table_box" class="mo-ms-tab-content-tile" style="width:135%;">
            <div class="mo-ms-tab-content-tile-content">
                <div style="font-size: 18px;font-weight: 650;height:1em !important;">Select Site and Drive</div>
                <div id="basic_attr_access_desc" class="mo_sps_help_desc" style="margin-bottom:20px;font-weight:500;">
                ...
                <?php if( "manual" === $app_type || "sharepoint" === get_option("mo_sps_cloud_connector")){ ?>
                    ...
                    <tr style="display:<?php echo isset($config['app_type']) && $config['app_type'] == 'auto' ? 'table-row' : 'none'; ?>">
                        ...
                        <td class="right-div">
                            <div style="background: #eee;padding: 8px;align-items: center;word-break:keep-all;">
                    ...
                    <tr>
                        ...
                        <td class="right-div" id="mo_sps_drive_select_td">
                            <div id="mo_sps_select_drive_loader" style="display:none;justify-content:center;align-items:center;">
                                <span><img width="40px" height="40px" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/loader.gif'); ?>"></span>
                            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div style="background-color:#eee;display:flex;align-items:center;">
                                ...
                                <div style="margin-left:3px;"><button type="button" class="mo_copy copytooltip rounded-circle float-end" style="background-color:#eee;width:40px;height:40px;margin-top:0px;border-radius:100%;border:0 solid;"><img style="width:25px;height:25px;margin-top:0px;margin-left:0px;" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/copy.png'); ?>" onclick="copyToClipboard(this, '#mo_copy_shortcode', '#copy_shortcode');"><span id="copy_shortcode" class="copytooltiptext">Copy to Clipboard</span></button></div>
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div style="display: flex">
                                <span class="dashicons dashicons-info-outline" style="margin-right: 4px;color: #135e96;"></span>
                                <a class="mo_sps_use_shortcode" href="<?php echo esc_url_raw(admin_url().'admin.php?page=mo_sps&tab=Shortcode');?>">[How to use this shortcode ?]</a>
                            </div>
        ...
        <div class="mo-ms-tab-content-tile" style="width:135%;padding: 1rem;background: #f4f4f4;border: 4px solid #A6DEE0;border-radius: 5px;margin-top:0px !important;padding-top:0px !important;">
            <div class="mo-ms-tab-content-tile-content mo-sps-prem-info" style="position:relative;">
                ...
                <div class="mo-sps-prem-lock" style="top:2px;right:2px;position:absolute;">
                    <img class="filter-green" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/lock.svg'); ?>">
                    ...
                    <div>
                        <div style="display:flex;align-items: center;justify-content: space-between;">
                                ...
                                <div id="mySearch_div">
                                    ...
                                    <div id="mySearchDropdown" class="search_div" >
                                        <div id="searching_div" style="display:flex;align-items:center;">
                                            ...
                                            <img id="mySearchLoader" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/Chasing_arrows.gif');?>">
                                        </div>
                                        <div class="list_div">
                            ...
                            <div <?php echo $disabled; ?> class="refresh" style="position:relative;">
                                <button type="button" style="pointer-events:<?php echo $pointer_events; ?>;display:flex;align-items:center;background:none;border:none;cursor:pointer;" id="mo_sps_doc_refresh" class="mo_sps_doc_refresh"><img style="width:20px;height:20px;" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/refresh.svg'); ?>"></button>
                                <p class="mo-refresh-content">Click here to refresh current documents and fetch updated from sharepoint</p>
                            </div>
                            </div>
                        </div>
                        ...
                        <div id="tableTOScroll">
                            ...
                            <div id="mo_sps_site_drive_not_selected" class="mo_sps_table_loader_div" style="display:none">
                                <div><img style="width:35px;height:35px;display:flex;align-items:center;display: block;margin-left: auto;margin-right:auto;" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/error.svg'); ?>"></div>
                                &nbsp;&nbsp;
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div class="mo_sps_table_loader_div">
                                                <img style="width:35px;height:35px;display:flex;align-items:center;display: block;margin-left: auto;margin-right:auto;" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/Chasing_arrows.gif'); ?>">
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
    ...
    private function mo_sps_display_generate_shortcode() {
        ?>
        <div class="mo_doc_lib_generate_shortcode_container">
            <div class="mo_doc_lib_gsc_heding">
                <div style="font-size:1.2rem;font-weight:510;">Generate Shortcode</div>
            </div>
           
            <div style="background-color:#eee;display:flex;align-items:center;margin-top:1.5em;">
                <span style="width:99%;margin-left:1rem;font-size:12px;" id="mo_copy_shortcode_gsc">[MO_SPS_SHAREPOINT width="100%" height="800px"]</span>
                <div style="margin-left:3px;"><button type="button" class="mo_copy copytooltip rounded-circle float-end" style="background-color:#eee;width:40px;height:40px;margin-top:0px;border-radius:100%;border:0 solid;"><img style="width:25px;height:25px;margin-top:0px;margin-left:0px;" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/copy.png'); ?>" onclick="copyToClipboard(this, '#mo_copy_shortcode_gsc', '#copy_shortcode_gsc');"><span id="copy_shortcode_gsc" class="copytooltiptext">Copy to Clipboard</span></button></div>
            </div>
            ...
            <br>
            <div style="background: #f4f4f4;border: 4px solid #A6DEE0;border-radius: 5px;padding-top:0px !important;">
                <div class="mo-ms-tab-content-tile-content mo-sps-prem-info" style="position:relative;">
                    <div>
                        <ul class="mo-ms-tab-ul">
                            <li id="mo_doc_lib_gsc_preview-disable" class="mo-ms-tab-li">
                                <div id="mo_doc_lib_gsc_preview_div" class="mo-ms-tab-li-div mo-ms-tab-li-div" style="border-bottom: 2px solid;">
                            ...
                            <div class="mo-sps-prem-lock" style="top:0.6rem;right:0.6rem;position:absolute;z-index:2;">
                                <img class="filter-green" src="<?php echo esc_url(MO_SPS_PLUGIN_URL . '/images/lock.svg'); ?>">
                                <p class="mo-sps-prem-text">Available in <a target="_blank" href="https://plugins.miniorange.com/microsoft-sharepoint-wordpress-integration#pricing-cards" style="color:#ffeb00;">Paid</a> plugins.</p>
                            </div>
                        </ul>
                    </div>
                    <div class="mo_doc_lib_gsc_tab_settings" id="mo_doc_lib_gsc_tab_settings">
                        <div>
                            <div class="mo_doc_lib_gsc_container">
                                <div class="mo_doc_lib_gsc">1. Default View:</div>
                                <div class="mo_doc_lib_gsc__inputs">
                                    <div class="mo_doc_lib_gsc__inputs_container">
                                        <div><input disabled type="radio" checked value="list_view" id="list_view" name="default-view">List View</div>
                                        <div><input disabled type="radio" value="grid_view" id="grid_view" name="default-view">Grid View</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="mo_doc_lib_gsc_container">
                                ...
                                <div class="mo_doc_lib_gsc__inputs">
                                    <div class="mo_doc_lib_gsc__inputs_container">
                                        <div><input disabled type="checkbox" checked value="breadcrumbs" name="elements-to-show">Breadcrumbs</div>
                                        <div><input disabled type="checkbox" checked value="toggle_view" name="elements-to-show">Toggle View</div>
                                        <div><input disabled type="checkbox" checked value="search_bar" name="elements-to-show">Search Bar</div>
                                        <div><input disabled type="checkbox" value="upload_btn" name="elements-to-show">Upload Button</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="mo_doc_lib_gsc_container">
                                ...
                                <div class="mo_doc_lib_gsc__inputs">
                                    <div class="mo_doc_lib_gsc__inputs_container">
                                        <div><input disabled type="checkbox" checked value="name" name="table-columns">Name</div>
                                        <div><input disabled type="checkbox" checked value="last_modified" name="table-columns">Last Modified</div>
                                        <div><input disabled type="checkbox" checked value="size" name="table-columns">Size</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="mo_doc_lib_gsc_container">
                                ...
                                <div class="mo_doc_lib_gsc__inputs">
                                    <div class="mo_doc_lib_gsc__inputs_container">
                                        <div><input disabled type="radio" checked value="pop_up" name="preview-option">Pop Up</div>
                                        <div><input disabled type="radio" value="new_tab" name="preview-option">New Tab</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="mo_doc_lib_gsc_container">
                                <div class="mo_doc_lib_gsc">5. File List View:</div>
                                <div class="mo_doc_lib_gsc__inputs">
                                    <div class="mo_doc_lib_gsc__inputs_container">
                                        <div><input disabled type="radio" checked value="expanded_view"  name="list-view-option">Expanded View</div>
                                        <div><input disabled type="radio"  value="compact_view" name="list-view-option">Compact View</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div>
                            <div class="mo_doc_lib_gsc_container">
                                <div class="mo_doc_lib_gsc">6. Shortcode Width (in percent):</div>
                                <div class="mo_doc_lib_gsc__inputs">
                                    <div class="mo_doc_lib_gsc__inputs_container">
                                        <input disabled type="number" class="cn" min=40 step=5 value="80" id="mo_doc_lib_gsc_pw_txt" name="preview-width">
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div id="mo_doc_lib_button_container" class="mo_sps_tooltip" name="mo_sps_copy_icon" style="cursor:pointer;margin:0.3rem;display:flex;justify-content:start;flex-grow:1;">
                        <input style="height:30px;"  type="button"  class="mo-ms-tab-content-button__disabled" value="Generate Shortcode" >
                    </div>
                </div>
            </div>
        </div>
