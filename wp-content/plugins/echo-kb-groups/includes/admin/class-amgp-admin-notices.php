...
class AMGP_Admin_Notices {
		...
		<div class="eckb-bottom-notice-message-large eckb-bottom-notice-message--error-large">
			...
			<div class="eckb-bottom-notice-message__header">
				...
				<div class="eckb-bottom-notice-message__header__clear-log">
					<a href="#" class="amgp_notice_reset_logs_ajax" data-nonce="<?php echo wp_create_nonce( "_wpnonce_epkb_ajax_action" ); ?>"><?php echo esc_html__( 'Clear Log', 'echo-knowledge-base' ); ?></a>
				</div>
	...
	function dismiss_admin_notices() {
		...
		if ( empty( $_GET['amgp_dismiss_notice_nonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_GET['amgp_dismiss_notice_nonce'] ) ), 'amgp_dismiss_notice') ) {
