 ...
 */
function asea_add_plugin_action_links ( $links ) {
	$my_links = array(
...
add_filter( 'plugin_action_links_' . plugin_basename(Echo_Advanced_Search::$plugin_file), 'asea_add_plugin_action_links' , 10, 2 );
 ...
 * @return array
 */
function asea_add_plugin_row_meta($links, $file) {
	if ( $file != 'echo-advanced-search/echo-advanced-search.php' ) {
		return $links;
	}
...
add_filter( 'plugin_row_meta', 'asea_add_plugin_row_meta', 10, 2 );
