...
class ASEA_KB_Editor_Main_Page_Config {
	...
	private static function search_box_zone() {
		...
		$settings = [
			...
			'advanced_search_mp_background_image_header'        => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'type' => 'header',
			...
			'advanced_search_mp_background_pattern_header'              => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'type' => 'header',
			...
			'advanced_search_mp_background_gradient_header'     => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'type' => 'header',
			...
			'advanced_search_mp_background_gradient' => [
				'editor_tab'        => self::EDITOR_TAB_FEATURES,
				'group_type'        => self::EDITOR_GROUP_MULTIPLE,
				'style_template'    => 'linear-gradient( advanced_search_mp_background_gradient_degreedeg, advanced_search_mp_background_gradient_from_color 0%, advanced_search_mp_background_gradient_to_color 100% )',
				'target_selector'   => '#asea-search-gradient-1',
				'style_name'        => 'background',
				'toggler'           => 'advanced_search_mp_background_gradient_toggle',
				'subfields' => [
			...
			// Advanced Tab
			'advanced_search_mp_box_padding'    => [
	...
	private static function search_title_zone() {
		...
		$settings = [
			...
			// Style Tab
			'advanced_search_mp_title_typography' => [
				'editor_tab' => self::EDITOR_TAB_STYLE,
				'target_selector' => '#asea-search-title',
			],
			...
			'advanced_search_mp_title_text_shadow' => [
				...
				'style_template' => 'advanced_search_mp_title_text_shadow_x_offset  advanced_search_mp_title_text_shadow_y_offset advanced_search_mp_title_text_shadow_blur advanced_search_mp_title_font_shadow_color',
				'target_selector' => '#asea-search-title',
	...
	private static function search_below_title_zone() {
		...
		$settings = [
			...
			// Style Tab
			'advanced_search_mp_description_below_title_typography' => [
				'editor_tab' => self::EDITOR_TAB_STYLE,
				'target_selector' => '#asea-search-description-1',
			],
			...
			'advanced_search_mp_description_text_shadow' => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'group_type' => self::EDITOR_GROUP_MULTIPLE,
				'toggler'           => 'advanced_search_mp_description_below_title_text_shadow_toggle',
				'style_template' => 'advanced_search_mp_description_below_title_text_shadow_x_offset  advanced_search_mp_description_below_title_text_shadow_y_offset ' .
				'advanced_search_mp_description_below_title_text_shadow_blur advanced_search_mp_description_below_title_font_shadow_color',
				'target_selector' => '#asea-search-description-1',
				'style_name' => 'text-shadow',
				'subfields' => [
			...
			// Advanced Tab
			'advanced_search_mp_description_below_title_padding'                => [
				'editor_tab' => self::EDITOR_TAB_ADVANCED,
				'group_type' => self::EDITOR_GROUP_DIMENSIONS,
				'label' => __( 'Padding', 'echo-advanced-search'),
				'units' => 'px',
	...
	private static function search_input_zone() {
		...
		$settings = [
			...
			'advanced_search_mp_filter_header'          => [
				'editor_tab' => self::EDITOR_TAB_CONTENT,
				'type' => 'header',
			...
			'advanced_search_mp_results_header'         => [
				'editor_tab' => self::EDITOR_TAB_CONTENT,
				'type' => 'header',
			...
			'advanced_search_mp_input_box_typography' => [
				'editor_tab' => self::EDITOR_TAB_STYLE,
			...
			'advanced_search_mp_input_box_shadow_header'        => [
				'editor_tab' => self::EDITOR_TAB_STYLE,
				'type' => 'header',
				'content' => __( 'Box Shadow', 'echo-advanced-search'),
			],
			'advanced_search_mp_input_box_shadow' => [
				'editor_tab' => self::EDITOR_TAB_STYLE,
				'group_type' => self::EDITOR_GROUP_MULTIPLE,
				'style_template' => 'advanced_search_mp_input_box_shadow_x_offset  advanced_search_mp_input_box_shadow_y_offset advanced_search_mp_input_box_shadow_blur advanced_search_mp_input_box_shadow_spread rgba(advanced_search_mp_input_box_shadow_rgba)',
				'target_selector' => '.asea-search-box',
			...
			'advanced_search_mp_filter_header_2'                => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'type' => 'header',
				'content' => __( 'Category Filter', 'echo-advanced-search'),
			],
			...
			'advanced_search_mp_filter_box_font_color'          => [
				...
				'style_name' => 'color',
				'toggler' => 'advanced_search_mp_filter_toggle',
			],
			...
			'advanced_search_mp_box_results_header'             => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'type' => 'header',
				'content' => __( 'Search Results', 'echo-advanced-search'),
			],
			...
			'advanced_search_mp_search_result_category_color'   => [
				'editor_tab' => self::EDITOR_TAB_FEATURES,
				'toggler'           => 'advanced_search_mp_show_top_category'
			],

			// Advanced Tab
			'advanced_search_mp_input_box_padding' => [
				'editor_tab' => self::EDITOR_TAB_ADVANCED,
				'group_type' => self::EDITOR_GROUP_DIMENSIONS,
	...
	private static function search_box_below_input_zone() {
		...
		$settings = [
			...
			'advanced_search_mp_description_below_input_typography' => [
				'editor_tab' => self::EDITOR_TAB_STYLE,
				'target_selector' => '#asea-search-description-2',
			],
			...
			'advanced_search_mp_description_below_input_padding' => [
				'editor_tab' => self::EDITOR_TAB_ADVANCED,
				'group_type' => self::EDITOR_GROUP_DIMENSIONS,
				'label' => __( 'Padding', 'echo-advanced-search'),
				'units' => 'px',
