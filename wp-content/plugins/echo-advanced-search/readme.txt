...
= 2.31.0, Aug 2, 2023 =
* New: added hook to allow users to modify search results
* Fix: Various minor fixes and improvements

= 2.30.1, Mar 4, 2023 =
* Update: Configurable search query parameter
* Fix: Various minor fixes and improvements

= 2.30.0, Jan 29, 2023 =
* New: Feature to not show draft categories in search
* Fix: Various minor fixes and improvements
...
= 2.28.0, June 26, 2022 =
* New: Timeframe for analytics data
...
= 2.26.1, Apr 8, 2022 =
* Fix: revert a fix for JS loading

= 2.26.0, Apr 2, 2022 =
* Update: Support for backend Editor
